...
async function selectBestArticles(req, res = response) {
    try {
        ...
        if( articlesToEvaluate.length > 0 ) {
            ...
            Descarta los artículos de opinión o entrevistas y, especialmente aquellos que incluyan el nombre del medio o algo tipo que hacemos por 'nombre de periodista'. 
            También descarta todos aquellos que sean de comunidades o,
            demasiado enfocados en una comunidad en concreto. 
            El resto de artículos necesito que tengas en cuenta que hay noticias muy similares dado que están extraidos de diferentes periódicos,
            por lo que muchos puede ser que sean casi el mismo. 
            Devuelme sólo el que te parezca más relevante por título. 
            En cuanto al reparto necesito que sean porcentualemente 
            aproximadamente entre un 10%-20% de artículos de internacional y política y el resto que de otros temas. 
            Me devolverás la id original del artículo y el título además de la mainCategory. 
            El formato de la respuesta tiene que ser un json ESTRICTAMENTE ASÍ: 
            articles:[ {id: 'id del artículo', title: 'título del artículo', mainCategory: 'categoría principal del artículo'}]. Necesito entre 10 a 20 artículos`;
